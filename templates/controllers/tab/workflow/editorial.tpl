...
<div id="editorial">
	...
	<div class="pkp_workflow_sidebar">
		{capture assign=copyeditingEditorDecisionsUrl}{url router=PKPApplication::ROUTE_PAGE page="workflow" op="editorDecisionActions" submissionId=$submission->getId() stageId=$stageId escape=false}{/capture}
	...
	<div class="pkp_workflow_content">
		{capture assign=finalDraftFilesGridUrl}{url router=PKPApplication::ROUTE_COMPONENT component="grid.files.final.FinalDraftFilesGridHandler" op="fetchGrid" submissionId=$submission->getId() stageId=$stageId escape=false}{/capture}
		...
		{capture assign=copyeditedFilesGridUrl}{url router=PKPApplication::ROUTE_COMPONENT component="grid.files.copyedit.CopyeditFilesGridHandler" op="fetchGrid" submissionId=$submission->getId() stageId=$stageId escape=false}{/capture}
