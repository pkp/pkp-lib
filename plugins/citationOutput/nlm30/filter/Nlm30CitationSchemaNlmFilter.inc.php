...
/**
 * @defgroup plugins_citationOutput_nlm_filter
 */

/**
 * @file plugins/citationOutput/nlm30/Nlm30CitationSchemaNlm30Filter.inc.php
 *
 * Copyright (c) 2000-2010 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class Nlm30CitationSchemaNlm30Filter
 * @ingroup plugins_citationOutput_nlm_filter
 *
...
class Nlm30CitationSchemaNlm30Filter extends Nlm30CitationSchemaCitationOutputFormatFilter {
	...
	function getClassName() {
		return 'lib.pkp.plugins.citationOutput.nlm.filter.Nlm30CitationSchemaNlm30Filter';
	}
