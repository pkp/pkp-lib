...
class DAO extends EntityDAO
{
    ...
    public function insert(Author $author): int
    {
        ...
        Repo::creditContributorRole()->addContributorRoles($author->getContributorRoleIdentifiers(), $newAuthorId);
    ...
    public function update(Author $author)
    {
        ...
        Repo::creditContributorRole()->addContributorRoles($author->getContributorRoleIdentifiers(), $author->getId());
