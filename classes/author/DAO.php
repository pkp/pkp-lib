...
class DAO extends EntityDAO
{
    ...
    public function insert(Author $author): int
    {
        ...
        Repo::creditContributorRole()->addContributorRoles(array_keys($author->getContributorRoles()), $newAuthorId);
    ...
    public function update(Author $author)
    {
        ...
        Repo::creditContributorRole()->addContributorRoles(array_keys($author->getContributorRoles()), $author->getId());
