...
class Author extends Identity
{
     ...
     */
    public function getContributorRoles(bool $withTranslations = true): array
    {
        $roles = $this->getData('contributorRoles') ?? [];
        return $withTranslations ? $roles : array_keys($roles);
    }

    /**
     * Set contributor roles.
     */
    public function setContributorRoles(?array $contributorRoles, ?int $contextId = null): void
    {
