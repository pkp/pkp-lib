...
/**
 * @file tests/plugins/citationOutput/vancouver/Nlm30CitationSchemaVancouverFilterTest.inc.php
 *
 * Copyright (c) 2000-2010 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class Nlm30CitationSchemaVancouverFilterTest
 * @ingroup tests_plugins_citationOutput_vancouver
 * @see Nlm30CitationSchemaVancouverFilter
 *
 * @brief Tests for the Nlm30CitationSchemaVancouverFilter class.
 */

import('lib.pkp.plugins.citationOutput.vancouver.Nlm30CitationSchemaVancouverFilter');
