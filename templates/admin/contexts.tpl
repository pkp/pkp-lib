...
{block name="page"}
	...
	{capture assign=contextsUrl}{url router=PKPApplication::ROUTE_COMPONENT component="grid.admin.context.ContextGridHandler" op="fetchGrid" escape=false}{/capture}
