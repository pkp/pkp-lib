...
class RemoveEmptyInternalReviewRound extends DecisionType implements DecisionRemovable
{
    use NotifyAuthors;
    use withReviewRound;
    ...
    public function validate(array $props, Submission $submission, Context $context, Validator $validator, ?int $reviewRoundId = null)
    {
        ...
        if (!$this->canRemove($submission, $reviewRoundId)) {
            $validator->errors()->add('restriction', __('editor.submission.decision.removeEmptyInternalReviewRound.restriction'));
        }
    ...
    /**
     * Determine if internal review round can be removed/deleted
     */
