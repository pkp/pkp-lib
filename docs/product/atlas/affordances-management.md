...
| AFFM-103 | ojs omp ops | `useUserAccessManagerConfig.js` action `common.edit` (USER_ACCESS_EDIT → `management/editUser`) | Users & roles · user row · Edit user (routes into role-assignment invitation flow). |
