...
// $Id: String.inc.php,v 1.19 2009/10/30 16:43:42 asmecher Exp $
...
class String {
	...
	* @return string
	*/	
	function buildJSON($status = 'true', $content) {
		return "{'status': $status, 'content': " . String::json_encode($content) . "}";
	}
