 ...
 *}
	...
	{if in_array($currentLocale, array('fr_CA', 'pt_BR'))}
		...
		<script src="{$baseUrl}/lib/pkp/js/lib/plupload/i18n/{$currentLocale|regex_replace:"/(.*)_(.*)/":"\\1-\\2"|strtolower}.js"></script>
	{elseif in_array(substr($currentLocale,0,2), array('cs', 'da', 'de', 'el', 'es', 'et', 'fa', 'fi', 'fr', 'hr', 'hu', 'it', 'ja', 'ko', 'lv', 'nl', 'pl', 'ro', 'ru', 'sk', 'sr', 'sv'))}
		...
		<script src="{$baseUrl}/lib/pkp/js/lib/plupload/i18n/{$currentLocale|substr:0:2}.js"></script>
	{/if}
