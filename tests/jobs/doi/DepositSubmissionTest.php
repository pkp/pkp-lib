...
class DepositSubmissionTest extends PKPTestCase
{
    ...
    public function testRunSerializedJob(): void
    {
        ...
        $submissionMock = Mockery::mock(\APP\submission\Submission::class)
            ...
            ->shouldReceive('getData')
            ->with('publications')
            ->andReturn(\Illuminate\Support\LazyCollection::make([$publicationMock]))
            ->getMock();
        ...
        $registrationAgency = new class implements \APP\plugins\IDoiRegistrationAgency
        {
        ...
        $depositSubmissionMock = Mockery::mock(DepositSubmission::class, [
                0, $contextMock, $registrationAgency
            ])
