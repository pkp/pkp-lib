...
{block name="page"}
	...
	<tabs :track-history="true">
		...
		<tab id="announcementTypes" label="{translate key="manager.announcementTypes"}">
			{capture assign=announcementTypeGridUrl}{url router=PKPApplication::ROUTE_COMPONENT component="grid.announcements.AnnouncementTypeGridHandler" op="fetchGrid" escape=false}{/capture}
