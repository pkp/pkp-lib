...
{capture assign=submissionHistoryGridUrl}{url params=$gridParameters router=PKPApplication::ROUTE_COMPONENT component="grid.eventLog.SubmissionEventLogGridHandler" op="fetchGrid" escape=false}{/capture}
