...
class ADODB_pdo extends ADOConnection {
	...
	{
		$saveDatabaseType = $this->_driver->databaseType;
	    if ($this->dsnType === 'sqlsrv') {
	        $this->_driver->databaseType = 'mssql';
	    }
		...
		$this->_driver->databaseType = $saveDatabaseType;
		return $ret;
	}
...
--------------------------------------------------------------------------------------*/
class ADORecordSet_mssql extends ADORecordSet_pdo {}
