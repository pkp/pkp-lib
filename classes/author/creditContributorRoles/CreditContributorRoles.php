...
/**
 * @file lib/pkp/classes/author/creditContributorRoles/CreditContributorRoles.php
 *
 * Copyright (c) 2025 Simon Fraser University
 * Copyright (c) 2025 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class CreditContributorRoles
 *
 * @brief CreditContributorRoles model class
 */
...
class CreditContributorRoles extends Model
{
    use HasCamelCasing;
