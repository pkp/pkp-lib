...
class FormComponent {
	 ...
	 * @param $locales array
	 */
	public function __construct($id, $method, $action, $successMessage, $locales) {
		$this->id = $id;
		$this->action = $action;
		$this->method = $method;
	...
	public function getConfig() {
		...
		if (empty($this->id) || empty($this->method) || empty($this->action) || empty($this->successMessage)) {
			throw new Exception('FormComponent::getConfig() was called but one or more required property is missing: id, method, action, successMessage.');
		}
