...
/**
 * @file api/v1/publicationOpenPeerReviews/resources/PublicationOpenPeerReviewResource.php
 *
 * Copyright (c) 2025 Simon Fraser University
 * Copyright (c) 2025 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING
 *
 * @class PublicationOpenPeerReviewResource
 *
...
namespace PKP\API\v1\publicationOpenPeerReviews\resources;
...
class PublicationOpenPeerReviewResource extends JsonResource
{
    ...
    private function getPublicationPeerReview(Publication $publication): Enumerable
    {
        ...
        while ($reviewRound = $reviewRounds->next()) {
            ...
            $roundsData->add([
                ...
                'reviews' => $this->getReviewAssignmentPeerReviews($assignments),
            ]);
        }
     ...
     *
     */
    private function getReviewAssignmentPeerReviews(Enumerable $assignments): Enumerable
    {
