...
/**
 * @file classes/migration/upgrade/v3_4_0/I7592_RemoveUnusedEmailTemplates.inc.php
 *
...
class I7592_RemoveUnusedEmailTemplates extends \PKP\migration\Migration
{
    ...
    {
        $emailKeys = ['REVIEW_REMIND_AUTO_ONECLICK', 'REVIEW_RESPONSE_OVERDUE_AUTO_ONECLICK'];
