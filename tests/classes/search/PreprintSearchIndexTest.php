...
class PreprintSearchIndexTest extends PKPTestCase {
	...
	public function testUpdateFileIndexViaPluginHook() {
		...
		HookRegistry::register('PreprintSearchIndex::submissionFileChanged', array($this, 'callbackUpdateFileIndex'));
	...
	public function testDeleteTextIndexViaPluginHook() {
		// Diverting to the search plugin hook.
		HookRegistry::register('PreprintSearchIndex::submissionFileDeleted', array($this, 'callbackDeleteTextIndex'));
	...
	public function testRebuildIndexViaPluginHook() {
		// Diverting to the search plugin hook.
		HookRegistry::register('PreprintSearchIndex::rebuildIndex', array($this, 'callbackRebuildIndex'));
	...
	public function testIndexPreprintMetadataViaPluginHook() {
		// Diverting to the search plugin hook.
		HookRegistry::register('PreprintSearchIndex::preprintMetadataChanged', array($this, 'callbackIndexPreprintMetadata'));
	...
	public function testIndexSubmissionFilesViaPluginHook() {
		// Diverting to the search plugin hook.
		HookRegistry::register('PreprintSearchIndex::submissionFilesChanged', array($this, 'callbackIndexSubmissionFiles'));
	...
	public function callbackUpdateFileIndex($hook, $params) {
		...
		list($preprintId, $type, $submissionFileId) = $params;
	...
	public function callbackDeleteTextIndex($hook, $params) {
		...
		list($preprintId, $type, $assocId) = $params;
		self::assertEquals(0, $preprintId);
		self::assertEquals(1, $type);
