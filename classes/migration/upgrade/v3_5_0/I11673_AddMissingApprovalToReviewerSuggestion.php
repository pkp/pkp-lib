...
class I11673_AddMissingApprovalToReviewerSuggestion extends Migration
{
    public function up(): void
    {
        ...
        // but there is a same email address match user and there is a review assignment for 
        ...
        $primaryKey = (new ReviewerSuggestion())->getKeyName();
        foreach ($suggestions as $suggestion) {
            ...
            DB::table('reviewer_suggestions')
                ->where($primaryKey, $suggestion->{$primaryKey})
                ->update([
                    'approved_at' => now(),
