    ...
    public function getConfig()
    {
        ...
        $config = array_merge(
            ...
            [
                ...
                'betweenDatesLabel' => __('stats.publications.exporting.betweenDates'),
                'allDatesLabel' => __('stats.publications.exporting.allDates'),
                'inFiltersLabel' => __('stats.publications.exporting.inFilters'),
                'inAllFiltersLabel' => __('stats.publications.exporting.inAllFilters'),
                'searchPhraseLabel' => __('stats.publications.exporting.withSearchPhrase'),
                'commonAndLabel' => __('common.and'),
