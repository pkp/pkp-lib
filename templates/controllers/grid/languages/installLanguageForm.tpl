...
<form class="pkp_form" id="installLanguageForm" method="post" action="{url router=PKPApplication::ROUTE_COMPONENT component="grid.admin.languages.AdminLanguageGridHandler" op="saveInstallLocale"}">
	{csrf}
