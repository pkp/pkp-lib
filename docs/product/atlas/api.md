...
| API-024 | ojs omp ops | `PKP\API\v1\invitations\InvitationController` | Invitations lifecycle (base `invitations`): GET {type}, GET {invitationId}, POST add/{type}, PUT {invitationId}/populate, PUT {invitationId}/invite, GET {invitationId}/getMailable, PUT {invitationId}/cancel, GET {invitationId}/key/{key}, PUT {invitationId}/key/{key}/finalize, PUT {invitationId}/key/{key}/refine, PUT {invitationId}/key/{key}/decline. |
