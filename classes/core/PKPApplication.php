...
abstract class PKPApplication implements iPKPApplicationInfoProvider
{
    ...
    public function __construct()
    {
        ...
        Hook::addUnsupportedHooks('API::_submissions::params', 'Template::Workflow::Publication', 'Template::Workflow'); // pkp/pkp-lib#10766 Removed with new submission lists for 3.5.0
