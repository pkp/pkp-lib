...
describe('Data suite: Rrossi', function() {
	let submission;

	before(function() {
		const title = 'Influence of long-term nutrition with different dietary fats on fatty acid composition of heavy pigs backfat';
		submission = {
			id: 0,
			section: 'Preprints',
			prefix: '',
			...
			shortAuthorString: 'Rossi',
			authorNames: ['Rosanna Rossi'],
			sectionId: 1,
			assignedAuthorNames: ['Rosanna Rossi'],
			authors: [
				{
					givenName: 'Rosanna',
					familyName: 'Rossi',
					email: 'rrossi@mailinator.com',
					country: 'Spain',
