...
/**
 * @file controllers/grid/settings/submissionChecklist/SubmissionChecklistGridHandler.php
 *
...
namespace PKP\controllers\grid\settings\submissionChecklist;

use PKP\controllers\grid\feature\OrderGridItemsFeature;
use PKP\controllers\grid\GridColumn;
use PKP\controllers\grid\settings\SetupGridHandler;
use PKP\controllers\grid\settings\submissionChecklist\form\SubmissionChecklistForm;
