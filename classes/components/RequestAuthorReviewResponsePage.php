...
class RequestAuthorReviewResponsePage
{
    ...
    public function getConfig(): array
    {
        ...
        $requestAuthorReviewResponse = new RequestAuthorReviewResponseManager(
        ...
        $mailable = $requestAuthorReviewResponse->getMailable();
        ...
        return [
            ...
            'emailTemplatesAxpiUrl' => $this->getEmailTemplatesApiUrl(),
            'canChangeRecipients' => false,
            'initialTemplateKey' => DecisionRequestRevisionsNotifyAuthor::getEmailTemplateKey(),
            'locale' => $this->context->getPrimaryLocale(),
            'locales' => $this->getLocales(),
            'emailTemplates' => $requestAuthorReviewResponse->getEmailTemplates($mailable),
    ...
    /**
     * @param array $recipients - Array of Author|User|Identity objects to format recipient options from
     */
