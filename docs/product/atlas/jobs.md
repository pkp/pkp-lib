...
| JOB-013 | ojs omp ops | `PKP\jobs\invitations\RemoveExpiredInvitationsJob` | Queued — removes all expired invitations. · Claimed by: U6 |
...
| JOB-051 | ojs omp ops | `PKP\task\RemoveExpiredInvitations` | Scheduled — dispatches expired-invitation cleanup; registered daily (PKPScheduler, all apps). · Claimed by: U6 |
