...
{elseif $pubObject instanceof PreprintGalley}
	<form class="pkp_form" id="publicIdentifiersForm" method="post" action="{url component="grid.preprintGalleys.PreprintGalleyGridHandler" op="updateIdentifiers" submissionId=$submissionId publicationId=$pubObject->getData('publicationId') representationId=$pubObject->getId() escape=false}">
