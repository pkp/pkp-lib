...
class PKPSubmissionEventLogEntry extends EventLogEntry
{
    ...
    public const SUBMISSION_LOG_REVIEW_REVIEWER_RECOMMENDATION_MODIFIED = 1073741858; // 0x40000022
    public const SUBMISSION_LOG_REVIEW_REVIEWER_COMMENTS_MODIFIED = 1073741859; // 0x40000023
    public const SUBMISSION_LOG_REVIEW_REVIEWER_FORM_RESPONSE_MODIFIED = 1073741860; // 0x40000024
    public const SUBMISSION_LOG_REVIEW_REVIEWER_COMPETING_INTERESTS_MODIFIED = 1073741861; // 0x40000025
    public const SUBMISSION_LOG_TASK_CREATED = 1342177281; // 0x50000001
    public const SUBMISSION_LOG_TASK_STARTED = 1342177282; // 0x50000002
    public const SUBMISSION_LOG_TASK_CLOSED = 1342177283; // 0x50000003
    public const SUBMISSION_LOG_TASK_OVERDUE = 1342177284; // 0x50000004
    public const SUBMISSION_LOG_TASK_NOTE_POSTED = 1342177285; // 0x50000005
    public const SUBMISSION_LOG_TASK_OPENED = 1342177286; // 0x50000006
    public const SUBMISSION_LOG_TASK_FILE_UPLOADED = 1342177287; // 0x50000007
    public const SUBMISSION_LOG_TASK_DATEDUE_MODIFIED = 1342177288; // 0x50000008
    public const SUBMISSION_LOG_TASK_REASSIGNED = 1342177289; // 0x50000009
    public const SUBMISSION_LOG_TASK_ASSIGNED = 1342177290; // 0x5000000A
    public const SUBMISSION_LOG_TASK_FILE_REMOVED = 1342177291; // 0x5000000B
    public const SUBMISSION_LOG_TASK_PARTICIPANTS_ADDED = 1342177292; // 0x5000000C
    public const SUBMISSION_LOG_TASK_PARTICIPANTS_REMOVED = 1342177293; // 0x5000000D
