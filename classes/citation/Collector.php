...
class Collector implements CollectorInterface
{
    ...
    /**
     * Filter citations by those matching a search query
     */
    ...
    {
        $qb = DB::table($this->dao->table . ' as c')->select('c.*');
            ...
            if (count($words)) {
                foreach ($words as $word) {
                    ...
                    $qb->where(function ($qb) use ($word) {
                        $qb->whereIn('c.citation_id', function ($qb) use ($word) {
                            $qb->select('rss.citation_id')
