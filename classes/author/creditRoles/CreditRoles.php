...
/**
 * @file lib/pkp/classes/author/creditRoles/CreditRoles.php
 *
...
class CreditRoles extends Model
{
    use HasCamelCasing;
     ...
     */
    protected $primaryKey = 'credit_roles_id';
