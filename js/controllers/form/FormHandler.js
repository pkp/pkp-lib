...
(function($) {
	...
	$.pkp.controllers.form.FormHandler = function($form, options) {
		...
		// We bind to both events because some browsers don't trigger unload all the time.
		// The handler will only fire once.
		$(window).bind('beforeunload unload', this.callbackWrapper(this.pageUnloadHandler_));
	...
	/**
	 * A state variable to determine if data has changed on the form.  For 'cancel' and 'page unload' warnings.
	 * @private
	 * @type {Boolean}
	 */
	...
	$.pkp.controllers.form.FormHandler.prototype.submitHandler_ =
		...
		// unbind the 'unsaved changes' event handler since the form is being submitted
