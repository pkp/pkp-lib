<?php
/**
 * @file classes/services/QueryBuilders/PKPContextListQueryBuilder.php
 *
 * Copyright (c) 2014-2018 Simon Fraser University
 * Copyright (c) 2000-2018 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class PKPContextListQueryBuilder
...
abstract class PKPContextListQueryBuilder extends BaseQueryBuilder {
