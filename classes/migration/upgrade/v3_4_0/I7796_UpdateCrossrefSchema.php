...
class I7796_UpdateCrossrefSchema extends \PKP\migration\Migration
{
    ...
    {
        DB::statement('UPDATE filter_groups SET output_type=? WHERE output_type = ?', ['xml::schema(https://www.crossref.org/schemas/crossref5.3.1.xsd)', 'xml::schema(https://www.crossref.org/schemas/crossref4.3.6.xsd)']);
    }
