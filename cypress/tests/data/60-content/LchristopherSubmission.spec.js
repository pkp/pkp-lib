...
describe('Data suite: Lchristopher', function() {
	let submission;

	before(function() {
		const title = 'Sodium butyrate improves growth performance of weaned piglets during the first period after weaning';
		submission = {
			id: 0,
			section: 'Preprints',
			prefix: '',
