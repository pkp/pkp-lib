...
class DashboardHandler extends Handler {
	...
	function DashboardHandler() {
		...
		$this->addRoleAssignment(array(ROLE_ID_SITE_ADMIN, ROLE_ID_MANAGER, ROLE_ID_GUEST_EDITOR, ROLE_ID_AUTHOR, ROLE_ID_REVIEWER, ROLE_ID_ASSISTANT, ROLE_ID_SUB_EDITOR),
