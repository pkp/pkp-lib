...
<form class="pkp_form" id="reviewFormForm" method="post" action="{url router=PKPApplication::ROUTE_COMPONENT component="grid.settings.reviewForms.ReviewFormGridHandler" op="updateReviewForm"}">
	{csrf}
