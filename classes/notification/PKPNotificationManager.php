...
class PKPNotificationManager extends PKPNotificationOperationManager
{
    ...
    public function getNotificationSettingsMap(): array
    {
        return [
            ...
            Notification::NOTIFICATION_TYPE_PUBLICATION_PUBLISHED => ['settingName' => 'notificationPublicationPublished',
                'emailSettingName' => 'emailNotificationPublicationPublished',
                'settingKey' => 'notification.type.publicationPublished'],
