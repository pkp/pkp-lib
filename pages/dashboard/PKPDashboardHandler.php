...
abstract class PKPDashboardHandler extends Handler
{
    ...
    public function index($args, $request)
    {
        ...
        $templateMgr->setConstants([
            ...
            'DECISION_WITHDRAW_REVIEW' => Decision::WITHDRAW_REVIEW,
            'DECISION_WITHDRAW_COPYEDITING' => Decision::WITHDRAW_COPYEDITING,
            'DECISION_WITHDRAW_PRODUCTION' => Decision::WITHDRAW_PRODUCTION,
            'DECISION_REVERT_WITHDRAW' => Decision::REVERT_WITHDRAW,
            'DECISION_REVERT_WITHDRAW_REVIEW' => Decision::REVERT_WITHDRAW_REVIEW,
            'DECISION_REVERT_WITHDRAW_COPYEDITING' => Decision::REVERT_WITHDRAW_COPYEDITING,
            'DECISION_REVERT_WITHDRAW_PRODUCTION' => Decision::REVERT_WITHDRAW_PRODUCTION,
