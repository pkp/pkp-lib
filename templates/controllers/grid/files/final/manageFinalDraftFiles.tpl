	...
	<div id="existingFilesContainer">
		...
		{fbvFormArea id="manageFinalDraftFiles"}
			{fbvFormSection}
				...
				{capture assign=availableReviewFilesGridUrl}{url router=PKPApplication::ROUTE_COMPONENT component="grid.files.final.ManageFinalDraftFilesGridHandler" op="fetchGrid" submissionId=$submissionId escape=false}{/capture}
