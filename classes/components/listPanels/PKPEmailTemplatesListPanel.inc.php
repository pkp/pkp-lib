...
class PKPEmailTemplatesListPanel extends ListPanel {
	...
	public function getConfig() {
		...
		$config['addSuccessMessage'] = __('manager.emails.addEmail.success');
		$config['delete'] = __('common.delete');
		$config['deleteConfirmMessage'] = __('manager.emails.confirmDelete');
		$config['deletedSuccessMessage'] = __('manager.emails.deleted');
		...
		$config['editSuccessMessage'] = __('manager.emails.editEmail.success');
