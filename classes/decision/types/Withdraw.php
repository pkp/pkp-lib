<?php
/**
 * @file classes/decision/types/Withdraw.php
 *
 ...
 * @class Withdraw
 *
 * @brief A decision to withdraw a submission in the initial submission stage
 *   before it has ever been published/posted.
 */
...
class Withdraw extends DecisionType
{
    ...
    {
        return __('editor.submission.decision.withdraw', [], $locale);
    }

    public function getDescription(?string $locale = null): string
    {
        return __('editor.submission.decision.withdraw.description', [], $locale);
    }

    public function getLog(): string
    {
        return 'editor.submission.decision.withdraw.log';
    }

    public function getCompletedLabel(): string
    {
        return __('editor.submission.decision.withdraw.completed');
    }

    public function getCompletedMessage(Submission $submission): string
    {
        return __('editor.submission.decision.withdraw.completed.description', [
    ...
    public function validate(array $props, Submission $submission, Context $context, Validator $validator, ?int $reviewRoundId = null)
    {
        ...
        if ($submission->getData('status') === Submission::STATUS_PUBLISHED) {
            $validator->errors()->add(
                'decision',
                __('editor.submission.decision.withdraw.errorPublished')
            );
        }
            ...
            switch ($action['id']) {
                case $this->ACTION_NOTIFY_AUTHORS:
                    $this->sendAuthorEmail(
                        new DecisionWithdrawNotifyAuthor($context, $submission, $decision),
