 ...
 *  in the UI Library.
 */
import('components.forms.FieldArchivingPn');
import('lib.pkp.components.forms.FieldColor');
import('lib.pkp.components.forms.FieldHTML');
import('lib.pkp.components.forms.FieldMetadataSetting');
import('lib.pkp.components.forms.FieldOptions');
import('lib.pkp.components.forms.FieldRadioInput');
import('lib.pkp.components.forms.FieldRichTextarea');
import('lib.pkp.components.forms.FieldSelect');
import('lib.pkp.components.forms.FieldShowEnsuringLink');
import('lib.pkp.components.forms.FieldText');
import('lib.pkp.components.forms.FieldTextarea');
import('lib.pkp.components.forms.FieldUpload');
import('lib.pkp.components.forms.FieldUploadImage');
...
class FormComponent {
	...
	public function addToPosition($id, $list, $item, $position) {
		...
		foreach ($list as $key => $val) {
			if ((is_a($val, 'Field') && $id === $val->name) || (!is_a($val, 'Field') && $id === $val['id'])) {
				$index = $key;
				break;
			}
		}
