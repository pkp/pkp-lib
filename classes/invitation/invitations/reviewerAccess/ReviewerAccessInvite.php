...
class ReviewerAccessInvite extends Invitation implements IApiHandleable
{
    ...
    {
        return new ReviewerAccessInviteCreateController($invitation);
    }

    public function getReceiveInvitationController(Invitation $invitation): ReceiveInvitationController
    {
        return new ReviewerAccessInviteReceiveController($invitation);
    }
    ...
    public function isUserReviewer(): bool
    {
        ...
        $currentUserGroups = Repo::userGroup()->userUserGroups($this->getUserId());
