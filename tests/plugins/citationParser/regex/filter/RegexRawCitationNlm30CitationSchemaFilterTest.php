...
/**
 * @defgroup tests_plugins_citationParser_regex_filter
 */

/**
 * @file tests/plugins/citationParser/regex/filter/RegexRawCitationNlm30CitationSchemaFilterTest.inc.php
 *
