...
abstract class PKPNativeImportExportPlugin extends ImportExportPlugin
{
	...
	public function executeCLI($scriptName, &$args)
	{
		...
		$user = $userDao->getByUsername($cliDeployment->userName);
		...
		if (!$request->getContext()) {
			HookRegistry::register('Router::getRequestedContextPaths', function (string $hook, array $args) use ($context): bool {
				$args[0] = [$context->getPath()];
				return false;
			});
