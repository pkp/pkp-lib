...
{if $submission->getStageId() >= $smarty.const.WORKFLOW_STAGE_ID_EDITING}
	...
	{capture assign=queriesGridUrl}{url router=PKPApplication::ROUTE_COMPONENT component="grid.queries.QueriesGridHandler" op="fetchGrid" submissionId=$submission->getId() stageId=$smarty.const.WORKFLOW_STAGE_ID_EDITING escape=false}{/capture}
