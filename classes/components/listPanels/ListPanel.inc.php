 ...
 */
abstract class ListPanel extends PKPHandler {
	...
	public function getItems() {
		fatalError('ListPanel::getItems() must be implemented in a child class. Attempted to use it in ' . get_class($this));
	}
	...
	protected function _getItemsParams() {
		fatalError('ListPanel::_getItemsParams() must be implemented in a child class. Attempted to use it in ' . get_class($this));
	}
}
